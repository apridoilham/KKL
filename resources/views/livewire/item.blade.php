                ...
                <form wire:submit.prevent="store" novalidate>
                    ...
                    <div class="space-y-6 p-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                <label for="harga_beli" class="text-sm font-medium text-slate-700">Harga Beli</label>
                                <div class="relative mt-1">
                                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                        <span class="text-slate-400 text-sm">Rp</span>
                                    </div>
                                    <input wire:model="harga_beli" id="harga_beli" type="number" step="0.01" min="0" placeholder="0.00" class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-3 placeholder-slate-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500">
                                </div>
                                @error('harga_beli') <span class="mt-1 text-xs text-red-500">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label for="harga_jual" class="text-sm font-medium text-slate-700">Harga Jual</label>
                                <div class="relative mt-1">
                                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                        <span class="text-slate-400 text-sm">Rp</span>
                                    </div>
                                    <input wire:model="harga_jual" id="harga_jual" type="number" step="0.01" min="0" placeholder="0.00" class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-3 placeholder-slate-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500">
                                </div>
